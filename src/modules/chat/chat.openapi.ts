...
// so a single import (`./modules/chat/chat.openapi.js`) at app boot fills the
// registry for every chat path. The split mirrors the route grouping in
// chat.routes.ts and keeps each file under the SRP file-size cap.
