      ...
      <div className="mx-auto w-full max-w-4xl px-4 py-8 md:px-6">
        <div className="mb-6">
          <div className="flex items-center gap-2">
            <span className="flex h-9 w-9 items-center justify-center rounded-md bg-primary-container/20 text-primary border border-primary-container/30">
              <MaterialIcon name="tune" className="text-base" />
            </span>
            <h1 className="text-xl font-semibold tracking-tight">Feature Management</h1>
          </div>
